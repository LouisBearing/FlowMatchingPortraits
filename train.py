...
# config = Config() --> TODO: supprimer cette classe config
parser = argparse.ArgumentParser()

# --------

###
## Arguments, TODO: beaucoup de choses qu'on ne va pas garder !
###
...
###
## Ancienne classe config, TODO: n'utiliser que la classe parser
# + multi GPU ? à faire traiter par lightning ?
###
...
###
## Instanciation dataset, train / val split, loaders, TODO: changer ? 
# + multi GPU ? à faire traiter par lightning ?
###
...
###
## Creation du modèle, TODO: à remplacer, on veut plus de class "Trainer", directement modèle génératif
## Idem classe métrique, à faire différemment
###
...
###
## Chargement depuis checkpoint précédent, autrement fichier de config sauvegardé 
# TODO-> plus besoin de ça, config changée dans .yaml, laissé juste pour s'en inspirer si besoin
###
...
###
## Ancienne méthode pour monitorer le best model, TODO: à cleaner / déplacer
###
...
###
## Training loop, TODO: simplifier avec lightning ? (voir si version pytorch requise par LIA empêche pas d'utiliser
# lightning)
###
...
while epoch < config.n_epochs:
    ...
    for batch in loader:
        ...
        ###
        ## Discriminator + Gen update, TODO: à remplacer par un truc plus simple, puisque un seul modèle !
        ###
        ...
        ###
        ## Validation step, TODO: à refacto largement, on va pas garder grand-chose de ça
        ###
