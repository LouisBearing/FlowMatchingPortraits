...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_dir', default='checkpoints/', help='Path to model weights & args file')
    parser.add_argument('--out_dir', default='./', help='Where to save output scores')
