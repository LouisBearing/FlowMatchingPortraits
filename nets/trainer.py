...
###
## Classe trainer TODO: à remplacer par le modèle (class Model/GenerativeModel/FM...whatever name we choose)
# Optim/schedulers pas ici (-> fichier train?)
# loss pas ici non plus
# la sortie du modèle doit être la séquence de latent générée
###
...
class AudioHMoTrainer(nn.Module):
    ...
    def __init__(self, config, load_syncer=True):
        ...
        ###
        ## TODO A supprimer, garder le gradient clipping value ?
        ###
        ...
        ###
        ## LipSyncers pour calculer la loss de corrélations AV TODO -> à déplacer, classe à part
        ###
        ...
        ###
        ## Optims, scheduler, TODO: à simplifier / déplacer 
        ## quel optim ? AdamW ? 
        ## Warmup ? 
        ## Quel LR decay ?
        ###
    ...
    def forward(self, batch, seq_len=None):
        ...
        ###
        ## Ancien forward, on peut s'en inspirer pour le traitement de l'audio / construction de l'audio pyramid
        ## en input
        ###
    ...
    ###
    ## Ancienne loss du générateur, TODO: à réécrire, garder loss de sync AV
    ###
    ...
    def gen_update(self, batch):
        ...
        # TODO voir si pb avec initial frame ? concaténer qq frames de la séquence précédente pour une transition
        # + smooth? Ils font ça dans FLOAT je crois.
    ...
    ###
    ## Anciennes loss functions TODO: plus besoin de la plupart
    ###
    ...
    ###
    ## TODO supprimer fonctions dont on n'a plus besoin
    ###
